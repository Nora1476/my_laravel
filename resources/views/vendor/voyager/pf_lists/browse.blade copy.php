{{--
pf_list admin페이지 오버라이딩
- view파일에 vendor > voyager> pf_lists(오버라이딩하는 페이지 라우팅주소) > browse.blade.php 파일 생성
- vendor > tcg > voyager > resources > view > bread 파일 내 browse.blade.php 코드 가져와서 사용
--}}
                            ...
                            <div class="col-2">
                                <select id="search_key" name="key">
                                    ...
                                    <option value="{{ $key }}" @if ($search->key == $key || (empty($search->key) && $key
                                        == $defaultSearchKey)) selected @endif>{{ $name }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div>
                                            {{ mb_strlen($data->{$row->field}) > 200 ? mb_substr($data->{$row->field},
                                            0, 200) . ' ...' : $data->{$row->field} }}
                                        </div>
